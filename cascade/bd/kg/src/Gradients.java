...
{
	private float[] m_texCoordX, m_texCoordY;
	private float[] m_oneOverZ, m_depth, m_lightAmt;

	private float m_texCoordXXStep, m_texCoordXYStep;
	private float m_texCoordYXStep, m_texCoordYYStep;
	private float m_oneOverZXStep, m_oneOverZYStep;
	private float m_depthXStep, m_depthYStep;
	private float m_lightAmtXStep, m_lightAmtYStep;
	...
	public Gradients(Vertex minYVert, Vertex midYVert, Vertex maxYVert)
	{
		...
		Vector lightDir = new Vector(300, 350, -500);
