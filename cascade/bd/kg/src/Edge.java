public class Edge
{
	...
	private float m_texCoordX, m_texCoordXStep;
	private float m_texCoordY, m_texCoordYStep;
	private float m_oneOverZ, m_oneOverZStep;
	private float m_depth, m_depthStep;
	private float m_lightAmt, m_lightAmtStep;
